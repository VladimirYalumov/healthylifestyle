...
function daysWrite(number) {
    ...
    var i;
    for (i = 1; i <= number; i++) {
        part += '<div id="day' + i + '" class="col-md-12 col-xs-10 border border-secondary rounded p-3" style="margin-top: 15px;">';
        part += '<h4>День ' + i + '</h4>';
        ...
        part += '<div id ="exerciseday' + i + '" class = "p-3">';
        part += '</div>';
        part += '</div>';
    }
    days.innerHTML = part;
...
function exercisesWrite(number, divID, dayID) {
    ...
    var i;
    for (i = 1; i <= number; i++) {
        part += '<div id="exercise' + i + dayID + '" class="form-group row bg-secondary text-white p-3 mb-2" style="margin-top: 15px;">';
        part += '<label for="nameexercise' + i + dayID + '" class="col-form-label col-md-4 col-xs-12">Название упражнения</label>';
        part += '<div class="col-md-8 col-xs-12">';
        part += '<input id="nameexercise' + i + dayID + '" type="text" class="form-control" name="name' + i + dayID + '">';
        part += '</div>';
        part += '<label for="numberexercise' + i + dayID + '" class="col-form-label col-md-7 col-xs-12" style="margin-top: 15px;">Количество раз за один подход</label>';
        ...
        part += '</div>';
        part += '<label for="appreachesexercise' + i + dayID + '" class="col-form-label col-md-7 col-xs-12" style="margin-top: 15px;">Количество подходов</label>';
        part += '<div class="col-md-5 col-xs-12" style="margin-top: 15px;">';
        part += '<input id="appreachesexercise' + i + dayID + '" type="number" class="form-control" name="appreaches' + i + dayID + '">';
        part += '</div>';
        part += '<label for="timeexercise' + i + dayID + '" class="col-form-label col-md-7 col-xs-12" style="margin-top: 15px;">Время на выполнение всех подходов</label>';
        part += '<div class="col-md-5 col-xs-12" style="margin-top: 15px;">';

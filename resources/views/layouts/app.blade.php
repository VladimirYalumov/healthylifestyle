        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
            ...
            <ul class = "navbar-nav">
                @if (Route::has('register'))
                    <li class="nav-item">
                        <a href="{{ route('register') }}" class="link nav-link">Регистрация</a>
                    </li>
                @endif

                <li class="nav-item">
                    <a href="{{ route('login') }}" class="link nav-link">Войти</a>
                </li>
            </ul>
            @else
            <ul class = "navbar-nav">
                <li class="nav-item">
                    <a href="{{route('home')}}" class="link nav-link">Личный кабинет</a>
                </li>

                <li class="nav-item">
                    <a href="{{ route('logout') }}" class="link nav-link">Выход</a>
                </li>
            </ul>
            @endguest
        </div>
